...
public class MyReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			try {
				JSONObject ob = new JSONObject(pushMsg);
				...
				AllMessage messgeManager = AllMessage.getInstance(type);//根据type获取相应的消息管理的对象
				if (messgeManager != null) {
					messgeManager.setMsg(list, true, true);
				}
			} catch (Exception e) {
			}
